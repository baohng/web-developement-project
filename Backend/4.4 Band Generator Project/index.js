...
app.post("/submit", (req, res) => {
  ...
  function generateName() {
    const randAdjElement = adj[Math.floor(Math.random() * adj.length)];
    const randNounElement = noun[Math.floor(Math.random() * noun.length)];
    const bandName = `${randAdjElement} ${randNounElement}`;
    return bandName;
  }
  res.render('index.ejs', {
